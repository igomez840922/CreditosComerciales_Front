      ...
      <div className="page-content">
        ...
        <Card>
          ...
          <CardFooter style={{ textAlign: "right" }}>
            ...
            <Button id="btnSearch" color="negative" type="button" style={{ margin: '5px' }} onClick={devolverEjecutivo}><i className="mdi mdi-call-missed mid-12px"></i>
            ...
            <Button id="btnSearch" color="danger" type="button" style={{ margin: '5px' }} onClick={devolverAnalista}><i className="mdi mdi-call-missed mid-12px"></i>
              {" "} {props.t("toRefuse")}</Button>
