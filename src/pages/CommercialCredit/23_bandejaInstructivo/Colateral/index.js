                                                ...
                                                <Col md="6" style={{ textAlign: "right" }}>
                                                    ...
                                                    <Button className="btn" color="success" type="button" style={{ margin: '5px' }} onClick={() => {
                                                        history.push({
                                                            pathname: '/creditocomercial/AdminDesembolso/GarantiaEquiposNuevosyUsados',
                                                            data: {
                                                                facilityId: idFacilidad ?? 0, transactionId: locationData?.transactionId ?? 0,
                                                                "containerId": locationData.containerId,
                                                                "priority": locationData.priority ?? "",
                                                                "infobpm": locationData.infobpm,
                                                                "requestId": locationData.requestId ?? "",
                                                                "facilityId": locationData.facilityId ?? "",
                                                                "facilityTypeId": locationData.facilityTypeId ?? "",
                                                                ...
                                                                "taskId": locationData.taskId ?? "",
                                                                "taskStatus": locationData?.taskStatus ?? ""
                                                            }
                                                            ,
                                                        });
